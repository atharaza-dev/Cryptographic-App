...
function TripleDES() {
    ...
    const encrypt = () => {
        const encrypted = CryptoJS.TripleDES.encrypt(inputText, keyText);
        setEncryptedText(encrypted.toString());
    };

    const decrypt = () => {
        const decrypted = CryptoJS.TripleDES.decrypt(encryptedText, keyText);
        ...
        <>
            <div className='py-12'>
                <div className='p-6 mx-32 font'>
                    <h2 className="text-4xl font-semibold mb-4">Triple Data Encryption Standards - 3x DES</h2>
                    ...
                    <div class="relative mb-4">
                        ...
                        <div className='flex items-center justify-center space-x-6'>
                            <input value={keyText} onChange={e => setKeyText(e.target.value)} type="text" class="w-full bg-slate-100 rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                    ...
                    <div className='flex w-full space-x-8'>
                        <div class="relative mb-4 flex-1">
                            ...
                            <textarea value={encryptedText} class="w-full bg-slate-100 rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 h-32 text-lg outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out" readOnly></textarea>
                        </div>
                        <div class="relative mb-4 flex-1">

...
function IDEAEncryption() {
    ...
    const decrypt = () => {
        const cipher = new IDEA(key);
        const decryptedText = cipher.decrypt(output);
    ...
    return (
        <div className='py-12'>
            <div className='p-6 mx-32 font'>
                <h1 className="text-4xl font-semibold mb-4">IDEA Encryption/Decryption</h1>
                ...
                <div className="relative mb-4">
                    <label htmlFor="plaintext" className="leading-7 text-sm text-gray-600">Enter Plain Text</label>
                    <textarea
                        id="plaintext"
                        name="plaintext"
                        className="w-full bg-slate-100 rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
